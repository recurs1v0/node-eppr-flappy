// EPPR
            ...
            function init() {
                ...
                manifest = [
                    ...
                    {src:"/images/pipe.png", id:"pipe"},
                    {src:"/images/restart.png", id:"start"},
            ...
            function handleComplete() {
                ...
                // document.body.insertAdjacentHTML('beforeend', '<img src="/images/button.png" style="height: 130px;" onclick="handleJumpStart()">');
            ...
            function die() {
                ...
                // Emit Score == counter.text
                submitMyScore(counter.text)
            ...
            function goShare() {
                ...
                window.open("https://twitter.com/share?url=http%3A%2F%2Feppr.link&text=I scored " + countText +  " en Flappy #EPPR");
            }
